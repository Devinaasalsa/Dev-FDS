...
@RestController
@RequestMapping(path = "/transaction_activity")
public class TransactionActivityResource extends ResponseResourceEntity<TransactionActivity> {
    protected final TransactionActivityService transactionActivityService;

    @Autowired
    public TransactionActivityResource(TransactionActivityService transactionActivityService) {
    ...
    public ResponseEntity<?> fetchAllData() {
        ...
        String httpMessage;
        try {
            List<TransactionActivity> fetchedData = transactionActivityService.fetchAllData();
            httpStatus = OK;
