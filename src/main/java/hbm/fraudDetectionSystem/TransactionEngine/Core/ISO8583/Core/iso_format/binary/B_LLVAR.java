...
public class B_LLVAR extends ISOStringHandler {
    public B_LLVAR(int fieldId, int length, String description, FieldRuleCondition fieldRuleCondition, boolean pad) {
        super(fieldId, length, description, BcdPrefixer.LL, AsciiInterpreter.INSTANCE, fieldRuleCondition, NullPadder.INSTANCE, pad);
