...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create().withIssuer(SecurityConstant.ISSUER_COMPANY).withAudience(SecurityConstant.GET_ARRAYS_ADMINISTRATION)
    ...
    public String generateRefreshToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create().withIssuer(SecurityConstant.ISSUER_COMPANY).withAudience(SecurityConstant.GET_ARRAYS_ADMINISTRATION)
                .withIssuedAt(new Date()).withSubject(userPrincipal.getUsername())
                .withArrayClaim(SecurityConstant.AUTHORITIES, claims).withExpiresAt(new Date(System.currentTimeMillis() + SecurityConstant.EXPIRATION_TIME_RT))
                .sign(HMAC512(secret.getBytes()));
    }
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(SecurityConstant.ISSUER_COMPANY).build();
